package org.rj.bs.config;

import org.rj.bs.web.controller.RJBSRestController;
...
public class RSApplicationInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
